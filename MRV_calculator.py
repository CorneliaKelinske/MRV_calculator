...
exp = int(
    input("For how many years have you been strength training? [number only] "))
age = int(input("How old are you? [number only] "))
diet = input(
    "How is your diet? \na: poor \nb: average \nc: good \n[a b or c] ")
sleep = int(
    input("How many hours of sleep do you usually get? [number only] "))
stress = input(
...
if MRV in range(10, 17):
    print(f"Your MRV for the squat is {MRV}.")
elif MRV > 16:
    print("Your MRV for the squat is 16.")
else:
    print("Your MRV for the squat is 10.")
